...
releaseverificatum: mkreleasedir lib/libgmpmee.so.0.0.0 lib/verificatum-vmgj-1.2.1.jar lib/libvmgj-1.2.1.so lib/verificatum-vcr-vmgj-3.0.3.jar lib/verificatum-vmn-3.0.3.jar
	cp lib/verificatum-vmgj-1.2.1.jar release/mixer/lib/verificatum-vmgj.jar
	cp lib/verificatum-vcr-vmgj-3.0.3.jar release/mixer/lib/verificatum-vcr.jar
	cp lib/verificatum-vmn-3.0.3.jar release/mixer/lib/verificatum-vmn.jar
	cp lib/libgmpmee.so.0.0.0 release/mixer/lib/libgmpmee.so.0
	cp lib/libvmgj-1.2.1.so release/mixer/lib/libvmgj-1.2.1.so
...
lib/ivxv-verificatum-$(VER).jar: lib/verificatum-vmn-3.0.3.jar lib/ivxv-common-$(VER).jar lib/ivxv-common-$(VER)-all.jar lib/ivxv-version.gradle
	gradle jar
	cp build/libs/ivxv-verificatum-$(VER).jar lib/ivxv-verificatum-$(VER).jar

lib/ivxv-common-$(VER).jar:
	../ivxv/common/external/gradle-3.0/bin/gradle -b ../ivxv/common/java/build.gradle jar
	cp ../ivxv/common/java/build/libs/common-$(VER).jar lib/ivxv-common-$(VER).jar

lib/ivxv-common-$(VER)-all.jar:
	../ivxv/common/external/gradle-3.0/bin/gradle -b ../ivxv/common/java/build.gradle jarall
	cp ../ivxv/common/java/build/libs/common-$(VER)-all.jar lib/ivxv-common-$(VER)-all.jar

lib/libgmpmee.so.0.0.0:
	$(MAKE) -C ../gmpmee -f Makefile.build
	cd ../gmpmee/; ./configure --prefix=$(PWD)/../ivxv-verificatum/build/
	$(MAKE) -C ../gmpmee
	$(MAKE) -C ../gmpmee install
	cp build/lib/libgmpmee.so.0.0.0 lib/

lib/verificatum-vmgj-1.2.1.jar: lib/libgmpmee.so.0.0.0
	...
	$(MAKE) -C ../vmgj
	$(MAKE) -C ../vmgj install
	cp build/share/java/verificatum-vmgj-1.2.1.jar build/lib/libvmgj-1.2.1.so lib/

lib/libvmgj-1.2.1.so: lib/libgmpmee.so.0.0.0
	$(MAKE) -C ../vmgj -f Makefile.build
	cd ../vmgj/; CPPFLAGS="-I$(PWD)/../ivxv-verificatum/build/include" LDFLAGS="-L$(PWD)/../ivxv-verificatum/build/lib/" ./configure --prefix=$(PWD)/../ivxv-verificatum/build/
	$(MAKE) -C ../vmgj
	$(MAKE) -C ../vmgj install
...
lib/verificatum-vcr-vmgj-3.0.3.jar: lib/verificatum-vmgj-1.2.1.jar
	$(MAKE) -C ../vcr -f Makefile.build
	cd ../vcr/; LD_LIBRARY_PATH=$(PWD)/../ivxv-verificatum/build/lib/ VMGJ_INFO=$(PWD)/../ivxv-verificatum/build/bin/vmgj-1.2.1-info ./configure --enable-vmgj --prefix=$(PWD)/../ivxv-verificatum/build/
	$(MAKE) -C ../vcr
	$(MAKE) -C ../vcr install
	cp build/share/java/verificatum-vcr-vmgj-3.0.3.jar lib/

lib/verificatum-vmn-3.0.3.jar: lib/verificatum-vcr-vmgj-3.0.3.jar
	$(MAKE) -C ../vmn -f Makefile.build
	cd ../vmn/; PATH=$(PATH):$(PWD)/../ivxv-verificatum/build/bin/ ./configure --prefix=$(PWD)/../ivxv-verificatum/build/
	$(MAKE) -C ../vmn
	$(MAKE) -C ../vmn install
	cp build/share/java/verificatum-vmn-3.0.3.jar lib/
...
clean:
	rm -rf release
	rm -rf build
	rm -f lib/verificatum-vmgj-1.2.1.jar
	rm -f lib/verificatum-vcr-vmgj-3.0.3.jar
	rm -f lib/verificatum-vmn-3.0.3.jar
	rm -f lib/ivxv-common-$(VER).jar
	rm -f lib/ivxv-common-$(VER)-all.jar
	rm -f lib/libgmpmee.so.0.0.0
	rm -f lib/libvmgj-1.2.1.so
	...
	$(MAKE) -C ../gmpmee clean
	$(MAKE) -C ../gmpmee -f Makefile.build clean
